# Q1662. Check If Two String Arrays are Equivalent – Java Solution

This repository contains a Java solution for the **LeetCode problem: Q1662. Check If Two String Arrays are Equivalent**.
