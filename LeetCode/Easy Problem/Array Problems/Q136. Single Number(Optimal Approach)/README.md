# Q136. Single Number(Optimal Approach) – Java Solution

This repository contains a Java solution for the **LeetCode problem: Q136. Single Number(Optimal Approach)**.
