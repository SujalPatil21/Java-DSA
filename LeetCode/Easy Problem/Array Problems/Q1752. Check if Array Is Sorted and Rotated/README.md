# Q1752. Check if Array Is Sorted and Rotated – Java Solution

This repository contains a Java solution for the **LeetCode problem: Q1752. Check if Array Is Sorted and Rotated**.
