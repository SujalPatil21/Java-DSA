# Q167. Two Sum II - Input Array Is Sorted – Java Solution

This repository contains a Java solution for the **LeetCode problem: Q167. Two Sum II - Input Array Is Sorted**.
