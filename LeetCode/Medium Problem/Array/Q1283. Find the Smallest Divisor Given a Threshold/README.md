# Q1283. Find the Smallest Divisor Given a Threshold – Java Solution

This repository contains a Java solution for the **LeetCode problem: Q1283. Find the Smallest Divisor Given a Threshold**.
